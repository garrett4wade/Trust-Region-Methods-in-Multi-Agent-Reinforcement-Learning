...
def get_config():
    ...
    parser = argparse.ArgumentParser(
        description='onpolicy_algorithm',
    ...
    parser.add_argument("--actor_distill_coef", type=float, default=0.0)
    parser.add_argument("--critic_distill_coef", type=float, default=0.0)
    ...
    parser.add_argument("--use_recurrent_policy",
                        action='store_true',
                        default=False,
                        help='use a recurrent policy')
    parser.add_argument("--recurrent_N",
                        type=int,
                        default=1,
