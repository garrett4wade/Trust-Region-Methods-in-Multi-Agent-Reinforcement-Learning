...
do
    ...
    --use_value_active_masks --use_eval --add_center_xy --use_state_agent --autoregressive #--share_policy --actor_distill_coef ${actor_distill_coef} --critic_distill_coef ${critic_distill_coef} #--autoregressive # --use_wandb
done
